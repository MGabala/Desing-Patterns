//State - The intent of this pattern is to allow an object to alter its behavior when ts internal state changes.The object will appear to change its class.
